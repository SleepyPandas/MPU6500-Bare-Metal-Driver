...
# # Serve static files for 3D models (assuming 'STLS' folder exists in current dir)
# base_path = pathlib.Path(__file__).parent
# app.add_static_files("/stls", base_path / "STLS")

# MODEL_FILE = "Anthony Hua.gltf"
# MODEL_URL = f"/stls/{quote(MODEL_FILE)}"
